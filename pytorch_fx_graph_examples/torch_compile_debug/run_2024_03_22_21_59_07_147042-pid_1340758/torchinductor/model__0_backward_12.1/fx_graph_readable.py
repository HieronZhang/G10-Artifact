class GraphModule(torch.nn.Module):
    def forward(self, primals_7: "f32[64, 784]", relu: "f32[64, 512]", relu_1: "f32[64, 512]", permute_3: "f32[10, 512]", permute_7: "f32[512, 512]", tangents_1: "f32[64, 10]"):
        ...
        alias: "f32[64, 512]" = torch.ops.aten.alias.default(relu)
        alias_1: "f32[64, 512]" = torch.ops.aten.alias.default(relu_1)
        ...
        mm_1: "f32[10, 512]" = torch.ops.aten.mm.default(permute_4, relu_1);  permute_4 = relu_1 = None
        ...
        view: "f32[10]" = torch.ops.aten.view.default(sum_1, [10]);  sum_1 = None
        permute_6: "f32[10, 512]" = torch.ops.aten.permute.default(permute_5, [1, 0]);  permute_5 = None
        alias_2: "f32[64, 512]" = torch.ops.aten.alias.default(alias_1);  alias_1 = None
        le: "b8[64, 512]" = torch.ops.aten.le.Scalar(alias_2, 0);  alias_2 = None
        ...
        mm_3: "f32[512, 512]" = torch.ops.aten.mm.default(permute_8, relu);  permute_8 = relu = None
        ...
        alias_3: "f32[64, 512]" = torch.ops.aten.alias.default(alias);  alias = None
        le_1: "b8[64, 512]" = torch.ops.aten.le.Scalar(alias_3, 0);  alias_3 = None
